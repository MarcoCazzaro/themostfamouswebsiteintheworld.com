...
We are committed to safeguarding the privacy of our users while providing a personalised and valuable service. This Privacy Policy statement explains our data processing practices. If you have any requests concerning your personal information or any queries with regard to these practices please contact us by e-mail at: ![privacy@snappysnail.io](/img/privacy-email.png "privacy@snappysnail.io")

Our sites may contain links to third party sites which are not subject to this privacy policy. We recommend that you read the privacy policy of any such sites that you visit.
...
Personal information includes information you provide us such as your first and last name, telephone number, postal and email addresses, user name and password or billing information (such as your credit card number, cardholder name, and card expiration date).

You can choose not to provide this personal information to us, but in general some information about you is required in order for you to receive relevant offerings and news from us and our partners and enjoy other benefits of being a registered member. In addition, some information is also required in order for you to ask us a question or initiate other transactions on our site.
...
We also may periodically communicate informations about you to our affiliated entities/companies or business partners and add it to other informations about you. We will work with our existing partners and potential future partners to improve and personalize your use of our website in accordance with the practices outlined in this Privacy Policy. We reserve the right to fully co-operate with any law enforcement authorities or court order requiring or requesting us to disclose the identity or other usage details of any user of our sites.
Our affiliated companies are listed below:
...
Please refer to our [Cookie Policy](https://themostfamouswebsiteintheworld.com/cookie-policy).

## Security Policy
We have appropriate measures in place to ensure that our users’ data is protected against unauthorised access or use, alteration, unlawful or accidental destruction and accidental loss. User data may be transferred outside the our company to data processors such as fulfilment houses but they will act only on our instructions to provide the services required.
...
If you wish to amend any of the data which we hold about you  please send an email to:
![privacy@snappysnail.io](/img/privacy-email.png "privacy@snappysnail.io")

In accordance with the Data Protection Act 1998, you may request a copy of the personal information we hold about you by contacting us by e-mail at:
![privacy@snappysnail.io](/img/privacy-email.png "privacy@snappysnail.io")
...
This policy is effective from January 2022. From time to time we may make changes to this privacy policy statement to reflect any changes to our privacy practices in accordance with changes to legislation, best practice or website enhancements.